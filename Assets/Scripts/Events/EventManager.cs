...
public static class EventManager
{
	...
	public static void Initialize()
    {
		...
		foreach (EventName name in Enum.GetValues(typeof(EventName)))
        {
            ...
            //Debug.Log("invokers has this many members: " + invokers.Count + " and listeners: " + listeners.Count);
            //Debug.Log("does it contain timerfinishedevent: " + invokers.ContainsKey(EventName.TimerChangedEvent));
		}
	}
